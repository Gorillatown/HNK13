/datum/job/weebcity/mayor
	...
	outfit = /datum/outfit/job/weebcity/mayor

	display_order = JOB_DISPLAY_ORDER_MAYOR

/datum/outfit/job/weebcity/mayor
	name = "_Town Mayor"
	jobtype = /datum/job/weebcity/mayor
...
/datum/outfit/job/weebcity/mayor/pre_equip(mob/living/carbon/human/H)
	..()
